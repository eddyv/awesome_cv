...
%\geometry{left=1.5cm, top=0.75cm, right=1.5cm, bottom=1.0cm, footskip=.25cm} % Configure page margins with geometry
...
\mobile{(+1) 647-674-0876}

\email{mahroo.mahan@gmail.com}
%\github{eddyv}
\linkedin{mahan-mahroo}
%\skype{skypeid}
...
%\xing{xing name}
\homepage{fuhitsuyostudios.com}
%\extrainfo{fuhitsuyostudios.com} % Other text you want to include on this line

\position{Account Manager{\enskip\cdotp\enskip}Commercial} % Your expertise/fields

\makecvfooter{\today}{Mahan Mahroo~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
%----------------------------------------------------------------------------------------
\input{cv-sections/professional-summary.tex}
